\capitulo{Conceptos teóricos}\label{cha:Conceptos teóricos}
...
El aprendizaje automático es un área de la inteligencia artificial que consiste
en el diseño de algoritmos y modelos que permitan a los ordenadores aprender la
regla general que define un conjunto de datos sin ser explícitamente programados
para ello.
