...
ser de utilidad para la realizar un diagnóstico inicial, pero nunca sustituyente
de una evaluación médica, sobre el estado de la enfermedad. Además, el enfoque
basado en vídeo es fácil de usar y no es invasivo, lo que lo hace potencialmente
