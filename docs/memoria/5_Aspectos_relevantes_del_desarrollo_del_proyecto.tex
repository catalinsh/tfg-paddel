...
\paragraph{Número de características} En un principio se realizó la búsqueda
...
Esto puede resultar ilógico, ya que las características se seleccionan
dependiendo de su relevancia estimada mediante pruebas de significancia. Se
sospecha que esto es debido a la forma en la que tratan los algoritmos algunas
combinaciones de atributos que no eran posibles al realizar una selección de
...
\imagen{results/3.png}{Comparación de algoritmos}{0.7}
...
\imagen{results/4.png}{Comparación de algoritmos}{0.7}
...
\imagen{results/5.png}{Comparación de algoritmos}{0.7}
...
Este modelo tiene una precisión medida del 78,8461538461539\%. Se debe tener en
cuenta que este valor se ha medido realizando validación cruzada con 5
repeticiones de 2 <<folds>>, por lo que esta precisión es la obtenida entenando
modelos únicamente con el 50\% de los datos disponibles, entonces es de esperar
que el rendimiento del modelo final, entrenado con todos los datos, sea mayor.
