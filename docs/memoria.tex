...
\begin{abstract}
    ...
    cifra que algunas fuentes prevén que va a subir en el futuro. Aunque es una
    ...
    bradicinesia, síntoma de la enfermedad de Parkinson, en un individuo de
...
\begin{abstract}
    ...
    order to detect bradykinesia, a common symptom of Parkinson's disease, in a
